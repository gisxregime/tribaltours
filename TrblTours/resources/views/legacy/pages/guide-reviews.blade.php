...
<head>
    ...
    <title>Tourist Reviews | Tribaltours Guide</title>
...
<body class="account-page" data-page="guide-reviews" data-require-auth="true">
        ...
        <div class="app-main">
            ...
            <main class="content-wrap">
                <section class="page-header d-flex align-items-center gap-3 mb-3">
                    ...
                    <div>
                        <h1 class="guide-page-title mb-0">Tourist Reviews</h1>
                        <p class="text-muted mb-0 small">All tourist reviews and related transactions</p>
                    </div>
                </section>

                <section class="guide-layout-grid">
                    <article class="settings-card">
                        <div id="guideReviewsFullList">
