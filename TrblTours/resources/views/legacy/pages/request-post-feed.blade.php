...
<head>
    ...
    <title>Request Post Feed | Tribaltours Guide</title>
...
<body class="account-page" data-page="guide-request-feed" data-require-auth="true">
        ...
        <div class="app-main">
            ...
            <main class="content-wrap">
                <section class="page-header">
                    <h1 class="guide-page-title">Request Post Feed</h1>
                    <p class="text-muted mb-0">Browse tourist request posts and leave comments for tourist selection.</p>
                </section>

                <section id="guideRequestFeed" class="request-manage-grid"></section>
                <div id="guideRequestEmpty" class="guide-empty" style="display:none;">No tourist request posts available yet.</div>
            </main>
        </div>
    </div>
