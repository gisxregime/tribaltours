...
<head>
    ...
    <title>Earnings Breakdown | Tribaltours Guide</title>
...
<body class="account-page" data-page="guide-earnings-breakdown" data-require-auth="true">
        ...
        <div class="app-main">
            ...
            <main class="content-wrap">
                <section class="page-header d-flex align-items-center gap-3 mb-3">
                    ...
                    <div>
                        <h1 class="guide-page-title mb-0">Earnings Breakdown</h1>
                        <p class="text-muted mb-0 small">All completed and paid tour transactions</p>
                    </div>
                    <div class="ms-auto">
                        <div class="earnings-breakdown-total-badge" id="earningsBreakdownTotal">₱0.00</div>
                    </div>
                </section>

                <section class="guide-layout-grid">
                    <article class="settings-card">
                        <div id="earningsBreakdownList" class="simulated-transaction-list">
