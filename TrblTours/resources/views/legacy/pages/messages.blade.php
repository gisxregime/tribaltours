...
<head>
    ...
    <title>Messages | Tribaltours Guide</title>
...
<body class="account-page" data-page="guide-messages" data-require-auth="true">
        ...
        <div class="app-main">
            ...
            <main class="content-wrap">
                <section class="page-header">
                    <h1 class="guide-page-title">Messages</h1>
                    <p class="text-muted mb-0">Conversation list and bubble behavior aligned with the tourist workspace chat flow.</p>
                </section>

                <section class="message-layout">
                    <aside class="conversation-list">
                        <div class="conversation-search">
                            <input id="guideMessageSearch" class="input-soft" type="text" placeholder="Search conversation">
                        </div>
