...
<head>
    ...
    <title>Tribaltours Likes</title>    <link href="https://fonts.cdnfonts.com/css/maragsa" rel="stylesheet">
...
<body class="account-page" data-page="likes" data-require-auth="true">
            ...
            <main class="content-wrap">
                <section class="likes-hero">
                    <div>
                        ...
                        <h1 class="page-title mb-0">Your Saved Tours</h1>
                    </div>
                    <div class="saved-count">Saved Count: <span data-saved-count>0</span></div>
                </section>

                <section id="likesEmpty" class="empty-state">
                    <div><i class="fa-solid fa-heart" style="color:#556B2F;"></i></div>
                    <h2 class="h5 mt-2">Like tours to save them here!</h2>
                    <p class="text-muted">Build your shortlist and return anytime.</p>
                    <button class="btn-gold" data-go-explore><i class="fa-solid fa-compass me-2"></i>Explore Tours</button>
                </section>

                <section id="likesGrid" class="masonry-grid"></section>
            </main>
        </div>
    </div>
